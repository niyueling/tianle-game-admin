<?php !defined('install') && exit(); ?>
                ...
                <div class="mounted-container" id="tab">
                    ...
                    <?php if ($step == '1') { ?>
                        <div class="mounted-content-item show">
                            ...
                            <div class="content">
                                <h2>版权所有(c)2019-<?=date('Y')?>，凡盟网络团队保留所有权利。</h2>
                                <p class="mt16">
                                    感谢你信任并选择凡盟网络，凡盟php系统由厦门凡盟网络科技有限公司原创研发并取得软件著作权，无加密，自主可控。</p>
                                <p class="mt6">为了正确并合法的使用本软件，请你在使用前务必阅读清楚下面的协议条款：</p>
                                <h3 class="mt16">一、本授权协议适用且仅适用于凡盟网络产品(以下简称fanmeng)任何版本，厦门凡盟网络科技有限公司拥有本授权协议的最终解释权。</h3>
                                <h3 class="mt16">二、协议许可的权利</h3>
                                <p class="mt6">
                                    1．版本可以付费商用，付费版本需要取得商业授权方可使用，否则会被视为盗版行为并承担相应法律责任。
                                </p>
                                <p class="mt6">
                                    2．请尊重fanmeng开源团队劳动成果，严禁使用本系统转手、转卖、倒卖或二次开发后转手、转卖、倒卖等商业行为。
                                </p>
                                <p class="mt6">
                                    3．任何企业和个人不允许对fanmeng程序代码以任何形式任何目的再发布。
                                </p>
                                <p class="mt6">
                                    4．你可以在协议规定的约束和限制范围内修改fanmeng系列产品或界面风格以适应你的网站要求。
                                </p>
                                <p class="mt6">
                                ...
                                <p class="mt6">
                                    1．付费版本需要取得商业授权方可使用，否则会被视为盗版行为并承担相应法律责任。
                                </p>
                                <p class="mt6">
                                    2．未经官方许可，不得对本软件或与之关联的商业授权进行出租、出售、抵押或发放子许可证。
                                </p>
                                <p class="mt6">
                                    3．未经官方许可，禁止在fanmeng开源商城的整体或任何部分基础上以发展任何派生版本、修改版本或第三方版本用于重新分发。
                                </p>
                                <p class="mt6">
                        ...
                        <div class="mounted-content-item show">
                            <div class="mounted-env-container">
                                ...
                                <div class="mounted-tips mt16">
                                    系统要求fanmeng安装目录下的runtime和upload必须可写，才能使用fanmeng的所有功能。
                                </div>
                                <div class="mounted-item mt16">
                                    <div class="content-header">
                                        目录权限监测
                            ...
                            <?php if ($step == '5') { ?>
                                <div class="show" id="mounting-success">
                                    ...
                                    <div class="success-content">
                                        ...
                                        <div style="margin-top: 5px;font-size:14px;">版本号：2.0.3</div>
                                        <div class="tips">
    ...
    <footer>
        Copyright © 2019-<?=date('Y')?> 厦门凡盟网络科技有限公司
    </footer>
