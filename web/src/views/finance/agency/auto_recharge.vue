<template>
    <div class="user-withdrawal">
        <div class="ls-card">
            <el-alert class="xxl" title="温馨提示： 1.代理自助充值记录。" type="info" :closable="false" show-icon>
            </el-alert>
                ...
                <el-form ref="formRef" inline :model="form" label-width="70px" size="small" class="ls-form">
                    <el-form-item label="状态">
                        <el-select v-model="form.status" placeholder="全部" style="width: 120px">
                            <el-option label="未支付" value="pending"></el-option>
                            <el-option label="已支付" value="finish"></el-option>
                        </el-select>
                    </el-form-item>
        ...
        <div class="ls-withdrawal__centent ls-card m-t-16">
            <div class="list-table m-t-16">
                ...
                >
                    ...
                    <el-table-column prop="gem" label="钻石数量"></el-table-column>
...
import { apiAgencyAutoRechargeLog, apiClubCreatorGoldLog } from '@/api/finance/finance'
...
export default class AccountLog extends Vue {
    ...
    getList(page?: number): void {
        ...
        this.pager
            .request({
                callback: apiAgencyAutoRechargeLog,
                params: {
                    ...this.form
                }
            })
    ...
    onExport() {
        this.form.export = 1
        apiAgencyAutoRechargeLog(this.form).then((res: any) => {
