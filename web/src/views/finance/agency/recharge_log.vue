<template>
    <div class="user-withdrawal">
        <div class="ls-card">
            <el-alert class="xxl" title="温馨提示： 1.代理充值记录。" type="info" :closable="false" show-icon>
            </el-alert>
            <div class="journal-search m-t-16">
                <el-form ref="formRef" inline :model="form" label-width="70px" size="small" class="ls-form">
                    <el-form-item label="充值币种">
                        <el-select v-model="form.currency" placeholder="全部" style="width: 120px">
                    ...
                    <el-form-item label="充值来源">
                        <el-select v-model="form.source" placeholder="全部" style="width: 120px">
                            <el-option label="后台充值" value="admin"></el-option>
                            <el-option label="自助充值" value="wechat"></el-option>
                        </el-select>
                    </el-form-item>
        ...
        <div class="ls-withdrawal__centent ls-card m-t-16">
            <div class="list-table m-t-16">
                ...
                >
                    <el-table-column prop="to" label="代理编号"> </el-table-column>
                    <el-table-column prop="agency.username" label="代理昵称"> </el-table-column>
                    <el-table-column prop="agency.role" label="角色"> </el-table-column>
                    <el-table-column prop="amount" label="充值钻石"></el-table-column>
                    <el-table-column prop="price" label="转账金额"></el-table-column>
                    <el-table-column prop="agency.gem" label="持有钻石"></el-table-column>
...
import { apiAgencyRechargeLog, apiClubCreatorGoldLog } from '@/api/finance/finance'
...
export default class AccountLog extends Vue {
    ...
    onExport() {
        this.form.export = 1
        apiAgencyRechargeLog(this.form).then((res: any) => {
