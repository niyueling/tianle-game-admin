<template>
    <div class="user-withdrawal">
        <div class="ls-card">
            <el-alert class="xxl" title="温馨提示： 1.会员红包领取记录。" type="info" :closable="false" show-icon>
            </el-alert>
        ...
        <div class="ls-withdrawal__centent ls-card m-t-16">
            <div class="list-table m-t-16">
                ...
                >
                    ...
                    <el-table-column prop="amountInFen" label="红包金额"></el-table-column>
                    ...
                    <el-table-column prop="juShu" label="局数"> </el-table-column>
...
import { apiClubCreatorGoldLog, apiUserRedPocketLog } from '@/api/finance/finance'
...
export default class AccountLog extends Vue {
    ...
    onExport() {
        this.form.export = 1
        apiUserRedPocketLog(this.form).then((res: any) => {
