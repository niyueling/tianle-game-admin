<template>
  <div class="user-withdrawal">
    <div class="ls-card">
      <el-alert class="xxl" title="温馨提示： 1.会员金豆变动记录。" type="info" :closable="false" show-icon>
      </el-alert>
    ...
    <div class="ls-withdrawal__centent ls-card m-t-16">
      <div class="list-table m-t-16">
        ...
        >
          ...
          <el-table-column prop="playerInfo.nickname" label="用户昵称"> </el-table-column>
          ...
          <el-table-column prop="amount" label="变动金豆"></el-table-column>
          <el-table-column prop="residue" label="剩余金豆"></el-table-column>
...
import { apiUserGoldList } from '@/api/finance/finance'
...
export default class AccountLog extends Vue {
  ...
  onExport() {
    this.form.export = 1
    apiUserGoldList(this.form).then((res: any) => {
