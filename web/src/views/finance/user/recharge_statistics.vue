<template>
    <div class="user-withdrawal">
        <div class="ls-card">
            <el-alert class="xxl" title="温馨提示： 1.会员充值记录。" type="info" :closable="false" show-icon>
            </el-alert>
        ...
        <div class="ls-withdrawal__centent ls-card m-t-16">
            <div class="list-table m-t-16">
                ...
                >
                    <el-table-column prop="dayId" label="日期"> </el-table-column>
                    <el-table-column prop="wechatGem" label="钻石微信充值"> </el-table-column>
                    <el-table-column prop="adminGem" label="钻石后台"> </el-table-column>
                    <el-table-column prop="wechatGold" label="金豆微信充值"> </el-table-column>
                    <el-table-column prop="adminGold" label="金豆后台充值"></el-table-column>
                </el-table>
            </div>
            <div class="flex row-right m-t-16 row-right" v-show="false">
...
import { apiUserRechargeStatistics } from '@/api/finance/finance'
...
export default class AccountLog extends Vue {
    ...
    getList(page?: number): void {
        ...
        this.pager
            .request({
                callback: apiUserRechargeStatistics,
                params: {
                    ...this.form
                }
            })
