        ...
        <div class="ls-withdrawal__centent ls-card m-t-16">
            <div class="list-table m-t-16">
                ...
                >
                    ...
                    <el-table-column prop="amount" label="变动钻石"></el-table-column>
                    <el-table-column prop="residue" label="剩余钻石"></el-table-column>
...
import { apiUserDiamondList } from '@/api/finance/finance'
...
export default class AccountLog extends Vue {
    ...
    onExport() {
        this.form.export = 1
        apiUserDiamondList(this.form).then((res: any) => {
