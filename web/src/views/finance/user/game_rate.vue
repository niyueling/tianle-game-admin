<template>
    <div class="user-withdrawal">
        <div class="ls-card">
            <el-alert class="xxl" title="温馨提示： 宝箱领取列表。" type="info" :closable="false" show-icon> </el-alert>
        ...
        <div class="ls-withdrawal__centent ls-card m-t-16">
            <div class="list-table m-t-16">
                ...
                >
                    ...
                    <el-table-column prop="level" label="宝箱等级"> </el-table-column>
                    <el-table-column prop="boxName" label="宝箱名称"></el-table-column>
                    <el-table-column prop="helpStr" label="补助类型"> </el-table-column>
                    <el-table-column prop="type" label="宝箱类型"> </el-table-column>
                    <el-table-column prop="createAt" label="掉落时间"> </el-table-column>
                </el-table>
            </div>
...
import { apiUserGameRateList } from '@/api/finance/finance'
