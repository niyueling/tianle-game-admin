                ...
                <el-form ref="formRef" inline :model="form" label-width="70px" size="small" class="ls-form">
                    ...
                    <el-form-item label="充值来源">
                        <el-select v-model="form.source" placeholder="全部" style="width: 120px">
                            <el-option label="微信充值" value="wechat"></el-option>
                        </el-select>
                    </el-form-item>
        ...
        <div class="ls-withdrawal__centent ls-card m-t-16">
            <div class="list-table m-t-16">
                ...
                >
                    ...
                    <el-table-column prop="player.nickname" label="用户昵称"> </el-table-column>
                  ...
                  <el-table-column prop="price" label="充值金额"></el-table-column>
                    <el-table-column prop="diamond" label="充值钻石"></el-table-column>
                    <el-table-column prop="source_str" label="变动类型"> </el-table-column>
...
import { apiAccountLog } from '@/api/finance/finance'
import { RequestPaging } from '@/utils/util'
import LsPagination from '@/components/ls-pagination.vue'
import { apiaddGameCategory } from '@/api/marketing'
@Component({
    components: {
        LsPagination
    }
...
// 顶部查询表单
    ...
    onExport() {
        this.form.export = 1
        apiAccountLog(this.form).then((res: any) => {
