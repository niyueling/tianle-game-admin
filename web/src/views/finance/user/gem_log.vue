        ...
        <div class="ls-withdrawal__centent ls-card m-t-16">
            <div class="list-table m-t-16">
                ...
                >
                    ...
                    <el-table-column prop="gem" label="变动数量"></el-table-column>
...
import { apiUserGemLog } from '@/api/finance/finance'
...
export default class AccountLog extends Vue {
    ...
    onExport() {
        this.form.export = 1
        apiUserGemLog(this.form).then((res: any) => {
