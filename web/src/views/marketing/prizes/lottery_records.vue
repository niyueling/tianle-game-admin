<template>
    <div class="user-withdrawal">
        <div class="ls-card">
            <el-alert class="xxl" title="抽奖记录。" type="info" :closable="false" show-icon> </el-alert>
        ...
        <div class="ls-withdrawal__centent ls-card m-t-16">
            <div class="list-table m-t-16">
                ...
                >
                    ...
                    <el-table-column prop="prizeConfig.name" label="奖品"> </el-table-column>
                    <el-table-column prop="hitStr" label="中奖状态"> </el-table-column>
                    <el-table-column prop="receiveStr" label="领奖状态"> </el-table-column>
                    <el-table-column prop="createAt" label="中奖时间"> </el-table-column>
                    <el-table-column prop="receiveAt" label="领奖时间"></el-table-column>
                </el-table>
            </div>
...
import { apiUserLotteryRecordLists } from '@/api/marketing/index.ts'
...
export default class AccountLog extends Vue {
    ...
    getList(page?: number): void {
        ...
        this.pager
            .request({
                callback: apiUserLotteryRecordLists,
                params: {
                    ...this.form
                }
            })
