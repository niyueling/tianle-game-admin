...
<template>
    <div class="flow-analysis">
            ...
            <div class="card-content m-t-24">
                <el-row :gutter="20">
                    <el-col :span="4" class="flex-col col-center">
                        <div class="lighter m-b-8">昨日访问量</div>
                        <div class="font-size-30">{{ summary.totalCount }}</div>
                    </el-col>
                    <el-col :span="3" class="flex-col col-center">
                        <div class="lighter m-b-8">昨日麻将数</div>
                        <div class="font-size-30">{{ summary.majiang }}</div>
                    </el-col>
                </el-row>
            </div>
        </div>
        ...
        <div class="ls-card m-t-24 ls-chart--visitors">
            <div class="card-title">访问量分析</div>
            <div class="content">
...
import { apiVisitorAnalysis } from '@/api/data/data'
echarts.use([
    BarChart,
    GridComponent,
    CanvasRenderer,
...
export default class FlowAnalysis extends Vue {
    ...
    getDataCenterVisit() {
        ...
        apiVisitorAnalysis(this.form).then(res => {
            this.summary = res.summary
            this.visitor.xAxis.data = res.visitor.date

            res.visitor.list.forEach((item: any, index: number) => {
